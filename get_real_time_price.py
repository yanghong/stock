...
# 688088 红软科技
# 002475 立讯精密 target: 40.00 在37.87位置，北向资金进入。
# 000725 京东方A  target: 6.05
# 600905 三峡能源 

stock_code_list = ['002157','600109','601066','000547','600999','600760','000558','600496','688088','002475','000725','600905']
stock_old_price_map = {}
...
def get_notice_price():
    ...
    for code in stock_code_list:
        ...
        notice_str = notice_str + datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S') + ' '+ name +' ： ' + ' ' + price + ' ' + str(drift) + ' ' + '\n'
